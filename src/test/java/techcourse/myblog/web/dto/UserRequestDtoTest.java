...
public class UserRequestDtoTest {
    ...
    void invalid_email() {
        assertUserRequestFirstViolationMessage(
            ...
            UserRequestDto.MESSAGE_EMAIL_FORMAT);
    }
    ...
    void username_non_alphabet() {
        assertUserRequestFirstViolationMessage(
            ...
            UserRequestDto.MESSAGE_USERNAME_FORMAT);
    }
    ...
    void username_under_size() {
        assertUserRequestFirstViolationMessage(
            ...
            UserRequestDto.MESSAGE_USERNAME_SIZE);
    }
    ...
    void password_under_size() {
        assertUserRequestFirstViolationMessage(
            ...
            UserRequestDto.MESSAGE_PASSWORD_SIZE
        );
    }
    ...
    void password_not_equal_to_confirm() {
        assertUserRequestFirstViolationMessage(
            ...
            UserRequestDto.MESSAGE_PASSWORD_EQUALITY
        );
    }
    ...
    void password_without_uppercase() {
        assertUserRequestFirstViolationMessage(
            ...
            UserRequestDto.MESSAGE_PASSWORD_FORMAT
        );
    }
